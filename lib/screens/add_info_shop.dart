...
class _AddInfoShopState extends State<AddInfoShop> {
  ...
  Widget saveButton() {
   ...
   Future<Null> uploadImage() async {
    ...
    String url = '${MyConstant().domain}/champshop/saveShop.php';
    ...
    try {
      ...
      await Dio().post(url, data: formData).then((value) {
        ...
        urlImage = '/champshop/Shop/$nameImage';
  ...
  Future<Null> editUserShop() async {
    ...
    String url =
        '${MyConstant().domain}/champshop/editUserWhereId.php?isAdd=true&id=$id&NameShop=$nameShop&Address=$address&Phone=$phone&UrlPicture=$urlImage&Lat=$lat&Lng=$lng';
