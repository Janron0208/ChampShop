...
class EditInfoShop extends StatefulWidget {
  const EditInfoShop({Key? key}) : super(key: key);
...
class _EditInfoShopState extends State<EditInfoShop> {
  ...
  Future<Null> editThread() async {
    ...
    String urlUpload = '${MyConstant().domain}/champshop/saveShop.php';
    print('### $nameFile');

    await Dio().post(urlUpload, data: formData).then((value) async {
      urlPicture = '/champshop/Shop/$nameFile';

      String? id = userModel!.id!;
      // print('id = $id');

      String url =
          '${MyConstant().domain}/champshop/editUserWhereId.php?isAdd=true&id=$id&NameShop=$nameShop&Address=$address&Phone=$phone&UrlPicture=$urlPicture&Lat=$lat&Lng=$lng';
