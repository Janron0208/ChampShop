...
class ShowShopTypeC extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeC({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeC> createState() => _ShowShopTypeCState();
}

class _ShowShopTypeCState extends State<ShowShopTypeC> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeC.php?isAdd=true';
