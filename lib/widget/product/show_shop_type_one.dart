...
class ShowShopTypeOne extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeOne({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeOne> createState() => _ShowShopTypeOneState();
}

class _ShowShopTypeOneState extends State<ShowShopTypeOne> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeOne.php?isAdd=true';
