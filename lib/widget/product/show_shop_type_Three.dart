...
class ShowShopTypeThree extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeThree({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeThree> createState() => _ShowShopTypeThreeState();
}

class _ShowShopTypeThreeState extends State<ShowShopTypeThree> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeThree.php?isAdd=true';
