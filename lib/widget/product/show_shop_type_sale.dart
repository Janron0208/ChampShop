...
class ShowShopTypeSale extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeSale({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeSale> createState() => _ShowShopTypeSaleState();
}

class _ShowShopTypeSaleState extends State<ShowShopTypeSale> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeSale.php?isAdd=true';
