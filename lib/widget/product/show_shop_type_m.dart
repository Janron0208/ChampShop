...
class ShowShopTypeM extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeM({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeM> createState() => _ShowShopTypeMState();
}

class _ShowShopTypeMState extends State<ShowShopTypeM> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeM.php?isAdd=true';
