...
class ShowShopTypeFive extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeFive({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeFive> createState() => _ShowShopTypeFiveState();
}

class _ShowShopTypeFiveState extends State<ShowShopTypeFive> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeFive.php?isAdd=true';
