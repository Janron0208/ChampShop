...
class ShowShopTypeFour extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeFour({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeFour> createState() => _ShowShopTypeFourState();
}

class _ShowShopTypeFourState extends State<ShowShopTypeFour> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeFour.php?isAdd=true';
