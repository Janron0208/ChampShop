...
class ShowShopTypeF extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeF({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeF> createState() => _ShowShopTypeFState();
}

class _ShowShopTypeFState extends State<ShowShopTypeF> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeF.php?isAdd=true';
