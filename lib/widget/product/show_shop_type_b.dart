...
class ShowShopTypeB extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeB({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeB> createState() => _ShowShopTypeBState();
}

class _ShowShopTypeBState extends State<ShowShopTypeB> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeB.php?isAdd=true';
