...
class ShowShopTypeAll extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeAll({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeAll> createState() => _ShowShopTypeAllState();
}

class _ShowShopTypeAllState extends State<ShowShopTypeAll> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> addOrderToCart(int index) async {
    ...
    String? nameProduct =
        '${productModels[index].nameProduct}(${productModels[index].size}/${productModels[index].color})';
