...
class ShowShopTypeG extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeG({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeG> createState() => _ShowShopTypeGState();
}

class _ShowShopTypeGState extends State<ShowShopTypeG> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeG.php?isAdd=true';
