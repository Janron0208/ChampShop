...
class ShowShopTypeTwo extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeTwo({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeTwo> createState() => _ShowShopTypeTwoState();
}

class _ShowShopTypeTwoState extends State<ShowShopTypeTwo> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeTwo.php?isAdd=true';
