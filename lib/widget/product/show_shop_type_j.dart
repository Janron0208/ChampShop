...
class ShowShopTypeJ extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeJ({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeJ> createState() => _ShowShopTypeJState();
}

class _ShowShopTypeJState extends State<ShowShopTypeJ> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeJ.php?isAdd=true';
