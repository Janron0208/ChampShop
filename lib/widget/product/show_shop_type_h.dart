...
class ShowShopTypeH extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeH({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeH> createState() => _ShowShopTypeHState();
}

class _ShowShopTypeHState extends State<ShowShopTypeH> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeH.php?isAdd=true';
