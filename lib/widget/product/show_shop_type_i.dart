...
class ShowShopTypeI extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeI({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeI> createState() => _ShowShopTypeIState();
}

class _ShowShopTypeIState extends State<ShowShopTypeI> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeI.php?isAdd=true';
