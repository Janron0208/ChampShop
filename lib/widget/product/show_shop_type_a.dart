...
class ShowShopTypeA extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeA({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeA> createState() => _ShowShopTypeAState();
}

class _ShowShopTypeAState extends State<ShowShopTypeA> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeA.php?isAdd=true';
