...
class ShowShopTypeE extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeE({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeE> createState() => _ShowShopTypeEState();
}

class _ShowShopTypeEState extends State<ShowShopTypeE> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeE.php?isAdd=true';
