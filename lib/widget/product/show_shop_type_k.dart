...
class ShowShopTypeK extends StatefulWidget {
  final UserModel userModel;
  const ShowShopTypeK({Key? key, required this.userModel}) : super(key: key);

  @override
  State<ShowShopTypeK> createState() => _ShowShopTypeKState();
}

class _ShowShopTypeKState extends State<ShowShopTypeK> {
  UserModel? userModel;
  String? idShop = '1';
  ...
  Future<Null> readProductMenu() async {
    idShop = '1';
    String url = '${MyConstant().domain}/champshop/apishowproducttype/getProductTypeK.php?isAdd=true';
